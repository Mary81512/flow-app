// app/detail/[id]/logdata/page.tsx
"use client"
...
// kleines Helferchen: Logdata-File rausfiltern
function getLogdataFile(files: File[]): File | undefined {
  return files.find((f) => f.kind === "logdata")
}

export default function LogdataPage({
  params,
}: {
  // wie bei Ticket/Report: params ist ein Promise
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-4 px-6 py-6">
        ...
        <section className="mt-6 flex-1">
          <div className="relative rounded-[3rem] bg-[#2f3238] px-10 py-8">
            ...
            {/* INHALT: Logdata-Kachel oder Hinweis */}
            {logdata ? (
              ...
              <div className="rounded-3xl bg-black/30 px-6 py-5 text-sm text-slate-200">
                Für diesen Auftrag sind noch keine Logdaten hinterlegt.
              </div>
            )}
          </div>
        </section>
